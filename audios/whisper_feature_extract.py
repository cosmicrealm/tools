# ref from https://github.com/TMElyralab/MuseTalk/tree/main/musetalk/whisper
import os
...
if __name__ == "__main__":
    audio_path = "/mnt/hwdata/cv/users/zhangjinyang/datasets/audio/video_original.wav"
    whisper_model_fname = (
        "/mnt/hwdata/cv/users/zhangjinyang/workspace/MuseTalk/models/whisper/tiny.pt"
    )

    audio_processor = Audio2Feature(model_path=whisper_model_fname)
